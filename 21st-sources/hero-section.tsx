// 21st.dev Component: Hero Section with background image + slogan + CTA + contact info
// Query: "hero editorial cinematic bold"
// Cached: 2026-04-21
// Borrowed: split-screen editorial layout, slogan uppercase lockup, clip-path reveal animation pattern, bottom contact strip
